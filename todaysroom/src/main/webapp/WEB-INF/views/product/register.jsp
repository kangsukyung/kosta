			...
			<div class="row">
				<div class="contents-col-lg-6">
					<div class="login_form_inner register_form_inner">
						<h3>필수 입력 사항</h3>
						<form class="contents-row login_form" action="/product/register" id="contents-register_form" method="post" enctype="multipart/form-data">
...
$(document).ready(function(e){
	...
	var formObj = $("form[role='form']");
	  ...
	  $("input[type='file']").change(function(e){
	    ...
	    var inputFile = $("input[name='product_fname']");
