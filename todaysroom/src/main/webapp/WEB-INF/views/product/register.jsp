...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/main_resource/vendors/nouislider/nouislider.min.css">
<link rel="stylesheet"
...
<script
	src="${pageContext.request.contextPath}/main_resource/js/jquery.js"
...
<body>
	<!-- ================ start banner area ================= -->
	<section class="blog-banner-area" id="product_header"> <!-- <img src="/main_resource/img/product_register_img.png"/> -->
			...
			<div class="contents-col-lg-6">
				<div class="login_form_inner register_form_inner">
					...
					<form role="form" class="contents-row login_form"
						action="/product/register" id="contents-register_form"
						method="post" enctype="multipart/form-data">

						<div class="select33" id="select3"></div>
						...
						<div class="col-md-12 form-group">
							<label id="product_insert_label">상품제목 </label> <input
								class="form-control" id="product_insert_input"
								name="store_title" type="text" placeholder="상품제목을 입력하세요."
								required="">
						</div>


						<div class="col-md-12 form-group">
							<label id="product_insert_label">스토어명 </label> <input
								class="form-control" id="product_insert_input" name="store_name"
						...
						<div class="col-md-12 form-group">
							...
							<div id="select-boxes">
								...
								</select> <select id="ption2" name="store_scategory" size="1">
									<option value="">선택해주세요.</option>
						...
						<div class="col-md-12 form-group">
							<label id="product_insert_label">상품가격 </label> <input
								class="form-control" id="product_insert_input"
								name="store_price" type="text" placeholder="가격을 입력하세요."
								required="">
						</div>

						<div class="col-md-12 form-group">
							<label id="product_insert_label_content">상품내용 </label>
							<textarea rows="30%" cols="70" class="form-control"
								id="store_content" name="store_content"
								placeholder="내용을 입력해주세요."></textarea>
						</div>

						<div class="form-group">
							<label id="product_insert_label">파일 </label> <input
								class="form-control" id="product_insert_input" name='uploadFile'
								type="file" placeholder="상품명을 입력하세요." required="" multiple>
						</div>
												...
												<div id="product_register" class="review_box">
													...
													<div id="test0">
														<label id="product_insert_label">상품명 </label> <input
															...
															required=""> <label id="product_insert_label">가격
														</label> <input class="form-control" id="product_insert_input"
															name="product_price" type="text" placeholder="가격을 입력하세요."
															required="">
														...
														<div class="col-md-12 form-group">
														 ...
														 <div class="select_img"><img src="" /></div> -->
															...
															<label id="product_insert_label">상품사진 </label> <input
																class="form-control" id="product_insert_input"
																id="gdsImg" name="product_fname" type="file"
																placeholder="상품제목을 입력하세요." required=""> <input
																type="hidden" name="product_uuid"> <input
																type="hidden" name="product_uploadpath">
	...
	<div class="col-md-12 form-group">
		<button type="submit" value="submit"
			class="button button-register w-100">상품등록</button>
	</div>
